...
<x-layout.section>
  <x-layout.inner class="privacy">
    <h1 class="text-plum">Datenschutzerklärung</h1>
    <p>Die Betreiber dieser Seiten nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.</p>
   
    <h2 class="text-plum mb-10">Cookies</h2>
    ...
    <h2 class="text-plum mb-10">Hosting Provider &amp; Server-LogFiles</h2>
    ...
    <h2 class="text-plum mb-10">Kontaktformular</h2>
    <strong class="text-plum">Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</strong><br>
    ...
    <strong class="text-plum">Dauer der Speicherung und Widerspruchsrecht</strong><br>
    <p>Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per E-Mail an <a href="mailto: info@smeyers.ch"> info@smeyers.ch</a> zu widerrufen. In einem solchen Fall kann die Konversation nicht fortgeführt werden.</p>
    <p>Alle personenbezogenen Daten, die im Zuge der Kontaktaufnahme gespeichert wurden, werden in diesem Fall gelöscht.</p>
    
    <h2 class="text-plum mb-10">Google Analytics</h2>
    <p>Diese Website nutzt Funktionen des Webanalysedienstes Google Analytics. Anbieter ist die Google Inc., 1600 Amphitheatre Parkway Mountain View, CA 94043, USA.</p>
    <p>Google Analytics verwendet so genannte „Cookies“. Das sind Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen. Die durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Website werden in der Regel an einen Server von Google in den USA übertragen und dort gespeichert.</p>
    <strong class="text-plum">IP Anonymisierung</strong><br>
    ...
    <strong class="text-plum">Browser Plugin</strong><br>
    ...
    <strong class="text-plum">Auftragsdatenverarbeitung</strong><br>
    <p>Wir haben mit Google einen Vertrag zur Auftragsdatenverarbeitung abgeschlossen und setzen die strengen Vorgaben der deutschen Datenschutzbehörden bei der Nutzung von Google Analytics vollständig um.</p>
    <strong class="text-plum">Demografische Merkmale bei Google Analytics</strong><br>
    ...
    <h2 class="text-plum mb-10">Google Maps</h2>
    <strong class="text-plum">Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</strong><br>
    ...
    <h2 class="text-plum mb-10">Recht auf Auskunft, Löschung, Sperrung</h2>
    <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an <a href="mailto: info@smeyers.ch" target="_blank"> info@smeyers.ch</a> senden.</p>
  
    <h2 class="text-plum mb-10">Verwendung von Adobe Fonts</h2>
